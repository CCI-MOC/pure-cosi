...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in cosi_pb2_grpc.py depends on'
...
def add_IdentityServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('cosi.v1alpha1.Identity', rpc_method_handlers)
...
def add_ProvisionerServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('cosi.v1alpha1.Provisioner', rpc_method_handlers)
